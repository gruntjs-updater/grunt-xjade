...
exports.xjade = {
  ...
  index: function(test) {
    ...
    test.equal(actual, expected, 'should compile index.js-tpl to index.html');
    test.done();
  },
  ...
  client: function(test) {
    ...
    test.equal(actual, expected, 'should compile client.js-tpl to client.js');
    test.done();
  },
  ...
  expand: function(test) {
    ...
    test.equal(actual1, expected1, 'should compile expand-1.js-tpl to expand-1.js');

    var actual2 = grunt.file.read('test/tmp/expand-2.js');
    var expected2 = grunt.file.read('test/expected/expand-2.js');
    test.equal(actual2, expected2, 'should compile expand-2.js-tpl to expand-2.js');
    test.done();
  },
  ...
  concat: function(test) {
    ...
    test.equal(actual, expected, 'should compile expand-1.js-tpl and expand-2.js-tpl to concat.js');
    test.done();
  },
};
